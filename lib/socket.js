...
Socket.prototype._handleData = function() {
  if (!this._readable) return;

  this._buffer = Buffer.concat([this._buffer].concat(this._readBuffer));
  this._readBuffer = [];
...
Socket.prototype._decodeExtendedLength = function() {
  ...
  if (expected > this._buffer.length) {
    this._readable = true;
    return;
  }
...
Socket.prototype._decodePayload = function() {
  var payloadLen = this._header.payloadLen;
  if (payloadLen > this._buffer.length) {
    this._readable = true;
    return;
  }
